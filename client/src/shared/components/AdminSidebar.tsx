...
import { FaChartPie, FaFilm, FaLayerGroup, FaCalendarCheck, FaChevronRight } from "react-icons/fa";
...
const AdminSidebar: React.FC = () => {
  ...
  return (
    <aside className="fixed top-0 left-0 h-screen w-72 bg-[#080808] border-r border-white/5 flex flex-col z-50">
      ...
      <div className="p-8 border-t border-white/5">
        <div className="bg-white/5 rounded-2xl p-4 border border-white/10 flex items-center space-x-4">
          ...
          <div className="flex-1 overflow-hidden">
            <p className="text-white text-[10px] font-black tracking-widest uppercase truncate">
              Admin User
            </p>
            <p className="text-gray-500 text-[8px] font-bold truncate">
              admin@cinechips.com
            </p>
          </div>
        </div>
      ...
      <div className="absolute bottom-0 left-0 w-full h-64 bg-gradient-to-t from-[#d4af37]/5 to-transparent pointer-events-none -z-10" />
    </aside>
  );
};
