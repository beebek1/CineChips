...
const AppFooter: React.FC = () => {
  return (
    <footer className="relative bg-[#050505] font-sans">
      <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-[#d4af37]/40 to-transparent shadow-[0_-10px_40px_rgba(212,175,55,0.1)]" />
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-32 bg-[#d4af37]/[0.02] blur-[100px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8">
        <div className="py-24 grid grid-cols-1 md:grid-cols-12 gap-16">
          ...
          <div className="md:col-span-2">
            <h3 className="text-[10px] font-black text-[#d4af37] uppercase tracking-[0.4em] mb-8">
              Navigation
            </h3>
            <ul className="space-y-4">
              {navLinks.map((link) => (
                <li key={link.label}>
                  <Link
                    to={link.to}
                    className="text-gray-500 hover:text-white transition-colors text-xs font-bold tracking-widest"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div className="md:col-span-4">
            ...
            <p className="text-gray-500 text-xs mb-6 tracking-wide">Subscribe for exclusive premiere invites.</p>
