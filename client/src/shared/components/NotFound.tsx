  ...
  return (
    <div className="min-h-screen bg-[#080808] flex items-center justify-center p-8 overflow-hidden relative">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-[#d4af37]/5 blur-[120px] rounded-full animate-pulse"
      ...
      <div className="max-w-2xl w-full text-center relative z-10">
        ...
        <div className="space-y-6">
          ...
          <div className="pt-12">
            <p className="text-gray-600 text-[9px] font-black tracking-[0.3em] uppercase mb-4">
              Or try searching for a movie
            </p>
