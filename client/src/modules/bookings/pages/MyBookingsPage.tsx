...
import { getCountdown } from "../booking.utils";
    ...
    <div className="min-h-screen bg-[#080808] text-white pt-32 pb-24 px-8 font-sans">
      ...
      <main className="max-w-5xl mx-auto space-y-10">
        ...
        {bookings.map((ticket) => (
          <div
            key={ticket.id}
            className="group relative bg-[#111] border border-white/5 rounded-[40px] overflow-hidden flex flex-col md:flex-row hover:border-[#d4af37]/40 transition-all duration-700 shadow-xl"
          >
            ...
            <div className="flex-1 p-10 flex flex-col justify-between">
              <div>
                <div className="flex justify-between items-start mb-6">
                  ...
                  <span className="flex items-center gap-2 text-[9px] bg-[#d4af37]/10 text-[#d4af37] border border-[#d4af37]/20 px-4 py-1.5 rounded-full font-bold animate-pulse">
                    ● ACTIVE
                  </span>
                </div>
